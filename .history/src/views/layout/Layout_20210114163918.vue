    ...
    >
      <div class="topTil flex al-center ju-center">
        ...
        >
           ...
           'dv':$route.path=='/about/pendulumBrake'&&index==2||'/about/wingBrake'&&index==2||'/about/threeGates'&&index==2
           ||'/about/panBrake'&&index==2||'/about/qualcommBrake'&&index==2||'/about/standColumn'&&index==2}"> {{ item.title }}</div>
